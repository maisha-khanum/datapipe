...
import torch
import numpy as np
from grounded_sam2 import build_sam2, SAM2ImagePredictor
from grounding_dino import load_model, predict
...
def run_gsam2(image_path, mask_path):
    ...
    grounding_model = load_model(GROUNDING_DINO_CONFIG, GROUNDING_DINO_CHECKPOINT, DEVICE)
