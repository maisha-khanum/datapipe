...
Matching_Pix_to_Ptcld::Matching_Pix_to_Ptcld() 
{
  ...
  // Publisher declarations
	image_color_filt_pub_ = nh.advertise<sensor_msgs::Image>("/processed_d455/image_gsam2_mask",1);
	image_color_filt_pub_ = nh.advertise<sensor_msgs::PointCloud2>("/processed_d455/points_gsam2_mask",1);
